...
import linkedil from "../../public/linkedil.svg";
    ...
    <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-green-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2 "></div>
      <div className="z-10">
        ...
        <div className="socials flex flex-row">
          <Link href="https://github.com/atikfouad">
            <Image src={github} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/mohammed-atik-faud/">
            <Image src={linkedil} alt="Linkedin Icon" />
          </Link>
        </div>
      </div>
      <div>
      <form className="flex flex-col" onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="atikfouad@gmail.com"
            />
          </div>
          <div className="mb-6">
            <label
